...
<div id="apply" class="wp-block-group alignfull molecule-affiliates-application" style="padding-top:var(--wp--preset--spacing--10);padding-bottom:var(--wp--preset--spacing--10)">
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column" style="flex-basis:40%">
			<!-- wp:heading {"level":2,"style":{"typography":{"fontSize":"clamp(2rem,4vw,2.5rem)","fontWeight":"800"},"spacing":{"margin":{"bottom":"var:preset|spacing|4"}}}} -->
			<h2 class="wp-block-heading" style="margin-bottom:var(--wp--preset--spacing--4);font-size:clamp(2rem,4vw,2.5rem);font-style:normal;font-weight:800;line-height:1.1"><?php esc_html_e( 'Request Partner Access', 'shadcn' ); ?></h2>
			<!-- /wp:heading -->
