...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--10);padding-bottom:var(--wp--preset--spacing--10)">
	<!-- wp:heading {"level":2,"style":{"typography":{"fontSize":"clamp(1.25rem,2.2vw,1.75rem)","fontWeight":"800","lineHeight":"1.15"},"spacing":{"margin":{"bottom":"var:preset|spacing|6"}}}} -->
	<h2 class="wp-block-heading" style="margin-bottom:var(--wp--preset--spacing--6);font-size:clamp(1.25rem,2.2vw,1.75rem);font-style:normal;font-weight:800;line-height:1.15"><?php esc_html_e( 'Your Online Peptide Guide for Research Applications', 'shadcn' ); ?></h2>
	<!-- /wp:heading -->
