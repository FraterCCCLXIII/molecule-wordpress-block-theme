...
<div class="wp-block-group alignfull molecule-affiliates-hero" style="border-bottom-color:var(--wp--preset--color--border);border-bottom-width:1px;padding-top:var(--wp--preset--spacing--10);padding-bottom:var(--wp--preset--spacing--8)">
	...
	<h1 class="wp-block-heading" style="margin-top:var(--wp--preset--spacing--6);margin-bottom:var(--wp--preset--spacing--6);font-size:clamp(1.5rem,2.8vw,2.25rem);font-style:normal;font-weight:800;line-height:1.1"><?php esc_html_e( 'Share Protocol Grade. Earn Commission.', 'shadcn' ); ?></h1>
	<!-- /wp:heading -->
