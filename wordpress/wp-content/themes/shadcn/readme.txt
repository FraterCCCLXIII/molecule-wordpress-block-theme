...
Molecule is a modern, lightweight WordPress theme built with component-driven design principles and contemporary web technologies.

== Description ==

Molecule is a modern, lightweight WordPress theme built with component-driven design principles and contemporary web technologies. Designed for developers and content creators who value clean code and excellent user experience. This theme emphasizes performance, accessibility, and ease of customization.
...
* Custom block patterns for quick content creation
...
A: Yes! The theme includes built-in dark mode support that automatically detects user system preferences.

**Q: Can I customize the colors?**
A: Yes, you can customize colors through the WordPress Customizer (Appearance > Customize).

**Q: Is this theme SEO friendly?**
A: Yes, the theme follows WordPress best practices and semantic HTML standards for better SEO.
