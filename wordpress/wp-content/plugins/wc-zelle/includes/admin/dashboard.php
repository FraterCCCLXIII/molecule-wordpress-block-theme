...
/**
 * Styles for the emailreceipts.io setup screen only.
 *
 * @param string $hook_suffix Current admin page hook.
 */
function wc_zelle_admin_email_receipts_styles() {
	$page = isset( $_GET['page'] ) ? sanitize_key( wp_unslash( $_GET['page'] ) ) : '';
	if ( 'wc_zelle_automated_status' !== $page ) {
		return;
	}
	wp_enqueue_style(
		'wc-zelle-admin-email-receipts',
		WCZELLE_PLUGIN_DIR_URL . 'assets/css/admin-email-receipts.css',
		array(),
		WCZELLE_PLUGIN_VERSION
	);
}

add_action( 'admin_enqueue_scripts', 'wc_zelle_admin_email_receipts_styles' );
